...
<Aside>Keep in mind that VideoFrame objects reside in graphics memory, and sending data to/from CPU memory incurs memory copy operations and performance overhead [[1](../../concepts/cpu-vs-gpu)] </Aside>
