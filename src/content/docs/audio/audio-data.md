...
Humans typically have 2 ears [[citation needed](../../reference/inside-jokes#citation-needed)], and our brains can interpret slight differences in sound coming in each ear to "hear" where a sound is coming from. 
...
Digital music or movies will often have slightly different signals in each channel for an immersive effect. Here's an example from [Big Buck Bunny](../../reference/inside-jokes#big-buck-bunny), where there's a sound effect created by two objects hitting a tree on the left side of the screen:
